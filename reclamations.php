...
$liste=$reclamation1C->getAllcommandeS($keywords);
}
?>
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navigation">
                    <form action="" method="POST">
                        <div class="input-group no-border">
                            <input type="text" value="" class="form-control" name="keywords" placeholder="Search...">
                    ...
                    <div class="card">
                        <div class="card-header">
                           <form  action="triedate.php">
                                            ...
                                            <h3  style="color:white " >Trier les commandes selon la date </h3><button> Trie</button>
                                </form>
                                ...
                                <table class="table">
                                    ...
                                    foreach($liste as $row){
                                        ...
                                        <tr>
                                            ...
                                            <td><?PHP echo $row['email_rec']; ?></td>
                                            <td><?PHP echo $row['titre_rec']; ?></td>
                                            <td><?PHP echo $row['message_rec']; ?></td>
                                            <td><form method="POST" action="../core/supprimerReclamation.php">
                                                    <input type="submit" name="supprimer" value="supprimer">
                                                    <input type="hidden" value="<?PHP echo $row['ref_rec']; ?>" name="ref">
                                                </form>
                                            </td>
                                        </tr>
                                        <?PHP
        ...
        <footer class="footer">
            <div class="container-fluid">
                ...
                <div class="copyright" id="copyright">
                    ...
                    <a href="https://www.invisionapp.com" target="_blank">Milky</a>. Coded by
                    <a href="https://www.creative-tim.com" target="_blank">Milky</a>.
                </div>
            </div>
        </footer>
    </div>
