...
function IsEmpty(){ 
	...
	else if(document.forms['Form'].descip.value == "")
	{
		alert("empty");
		return false;
	}
	...
	<form method="POST" action="ajoutcategorie.php" name="Form" onsubmit="return IsEmpty();">
    <div class="panel-body">
       
		<div class="form-group has-warning">
                        <label class="control-label" for="warning">Nom du categorie</label>
