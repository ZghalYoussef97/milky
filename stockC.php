...
function afficherstock ($stock){
		...
		echo "description: ".$stock->getdescription()."<br>";
		echo "categorie: ".$stock->getcategorie()."<br>";
		echo "fichier: ".$stock->getfichier()."<br>";
	}
	function ajouterstock($stock){
		$sql="insert into stock (nom,prix,quantite,description,categorie,fichier) values (:nom,:prix,:quantite,:description,:categorie,:fichier)";
	...
	function modifierstock($stock,$id){
		$sql="UPDATE stock SET nom=:nom,prix=:prix,quantite=:quantite,description=:description,categorie=:categorie WHERE id=:id";
...
try{		
		...
		$datas = array(':nom'=>$nom,':prix'=>$prix,':quantite'=>$quantite,':description'=>$description,':categorie'=>$categorie);
		$req->bindValue(':id',$id);
		$req->bindValue(':nom',$nom);
		$req->bindValue(':prix',$prix); 
		$req->bindValue(':quantite',$quantite);
