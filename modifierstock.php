...
if (isset($_POST['modifier'])){
	$stock=new stock($_POST['nom'],$_POST['prix'],$_POST['quantite'],$_POST['description'],$_POST['categorie'],$_POST['fichier']);
...
<head>
				...
				<aside class="app-sidebar">
					<div class="app-sidebar__user">
						<div class="dropdown user-pro-body text-center">
							...
							<div class="user-info">
								<h6 class=" mb-1 text-dark">Issam Dziri</h6>
    ...
    <div class="panel-body">
        ...
        <div class="form-group has-success">
					...
					<div class="form-group has-success">
                        <label class="control-label" for="success">Saisir la description</label>
                        <input type="text" class="form-control" id="success" name="description" value="<?PHP echo $description ?>"/>
                    </div>
					<div class="form-group has-success">
					...
					<div class="form-group has-success">
					<td><img src="../../img/<?php echo $row['fichier'];?>" width="100" height="100"></td>
                    </div>
                </form>
