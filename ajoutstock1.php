...
function IsEmpty(){ 
	...
	else if(document.forms['Form'].prix.value == "")
	{
		alert("Remplir le Prix");
		return false;
	}
	else if(document.forms['Form'].quantite.value == 0)
	{
		alert("Quantite must not be 0");
		return false;
	}
	return;
}
	...
	<form method="POST" action="ajoutstock.php" name="Form"  onsubmit="return IsEmpty();">
    <div class="panel-body">
					...
					<div class="form-group has-success">
                        ...
                        <input type="text" class="form-control" id="success" name="description"/>
                    </div>
					 <div class="form-group has-warning">
