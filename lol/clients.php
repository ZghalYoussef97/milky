                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title"> Liste des Clients</h4> <a href="formClient.php"><button >ajouter</button></a>
                        </div>
