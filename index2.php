					...
					<ul class="navbar-nav navbar-right">
							...
							<div class="dropdown-menu dropdown-list dropdown-menu-right">
								...
								<div class="dropdown-list-content">
									<a href="#" class="dropdown-item dropdown-item-unread">
										<img alt="image" src="assets/img/avatar/" class="rounded-circle dropdown-item-img">
						...
						<li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg d-flex">
								<span class="mr-3 mt-2 d-none d-lg-block ">
									<span class="text-white">Hello,<span class="ml-1"> Issam Dziri</span></span>
								</span>
							<span><img src="assets/img/avatar/" alt="profile-user" class="rounded-circle w-32 mr-2"></span>
							</a>
							<div class="dropdown-menu dropdown-menu-right">
								<div class=" dropdown-header noti-title text-center border-bottom pb-3">
									<h5 class="text-capitalize text-dark mb-1">Issam Dziri</h5>
					...
					<div class="app-sidebar__user">
						<div class="dropdown user-pro-body text-center">
							<div class="nav-link pl-1 pr-1 leading-none ">
								<img src="assets/img/avatar/" alt="user-img" class="avatar-xl rounded-circle mb-1">
					...
					<ul class="side-menu">
						<li class="slide">
							...
							<ul class="slide-menu">
								...
								<li><a class="slide-item" href="index2.php"><span>Gestion categorie</span></a></li>
						...
						<li class="slide">
							...
							<ul class="slide-menu">
								<li><a href="backend/livreur.php" class="slide-item"> Gestion livreur</a></li>
								<li><a href="backend/livraison.php" class="slide-item"> Gestion livraison</a></li>
							</ul>
						</li>
						<li class="slide">
							<a class="side-menu__item" data-toggle="slide" href="#"><i class="side-menu__icon fe fe-grid"></i><span class="side-menu__label">Gestion compte</span></a>
							<ul class="slide-menu">
							...
							<div class="col-12 col-sm-12">
								<div class="card">
									<div class="card-header">
										...
										<h4>categorie Summary</h4>
									</div>
									<a href="ajoutcategorie1.php">
