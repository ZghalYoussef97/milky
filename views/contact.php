                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="header_contact_details">
                            <a href="#"><i class="fa fa-phone"></i>+21628342342</a>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="row contact_form_area">
                            <h3 class="contact_title">Envoyer Reclamtion</h3>
                            <form action="../core/contact_process.php" method="POST" id="mailForm">
                                ...
                                <div class="form-group col-md-12">
                                  <textarea class="form-control" id="message" name="message" placeholder="Ecrivez votre Message"></textarea>
                                </div>
                                <div class="form-group col-md-12">
                                    <button class="btn btn-default submit_btn" type="submit" value="submit">Envoyer</button>
                                 </div>
                            </form>
                            <div id="success">
                                <p style="color: #4cae4c">Votre message a été envoyé!</p>
                            </div>
                            <div id="error">
                                <p>Désolé! votre message n'a pas été envoyé, vérifiez les champs!!</p>
                            </div>
                        </div>
                    </div>
                </div>
